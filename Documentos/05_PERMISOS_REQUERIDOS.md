...
| **READ_PHONE_STATE** | Detectar si está en llamada | Opcional | Runtime |
| **READ_EXTERNAL_STORAGE** | Leer documentos médicos | Opcional | Runtime |
| **WRITE_EXTERNAL_STORAGE** | Guardar documentos | Opcional | Runtime |
| **CAMERA** | Fotografiar documentos | Opcional | Runtime |
| **INTERNET** | Conectar con Firebase | SÍ | Installation |
| **ACCESS_NETWORK_STATE** | Detectar conexión | SÍ | Installation |
| **POST_NOTIFICATIONS** | Enviar notificaciones | Importante | Runtime |
| **MODIFY_AUDIO_SETTINGS** | Alarma de emergencia | Opcional | Installation |
...
- `WRITE_EXTERNAL_STORAGE` - Para guardar historial
### documents.dart (Documentos Médicos)
- `CAMERA` - Para fotografiar documentos
- `READ_EXTERNAL_STORAGE` - Para seleccionar documentos
